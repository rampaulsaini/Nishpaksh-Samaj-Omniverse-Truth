...
![निष्पक्ष समझ](https://i.ibb.co/xqf3kTPS/enhanced-image.webp)
...
3. **Enable GitHub Pages**:  
   ...
   - Save  
4. **Live Dashboard** अब इस URL पर मिलेगा:  
5. README.md में केवल **photo और live link** दिखेंगे। Golden effect केवल live dashboard page पर।  
